...
export default function Portfolio() {
  ...
  const projects = [
    ...
    { title: "Vector Solutions", date: "Dec 2019 - Dec 2020", tech: ["AWS FSx", "AWS Transfer for SFTP", "Sysprep AMIs", "Octopus Deploy"], desc: "Provided AWS DevOps Architecture to migrate a RackSpace Production Environment to AWS. Lifted and shifted file and SFTP servers using AWS FSx and AWS Transfer for SFTP. Baked custom Windows AMIs using Sysprep and implemented CI/CD via Octopus Deploy." },
    { title: "Amway", date: "Sep 2019 - Dec 2019", tech: ["Elastic Beanstalk", "ECS Fargate", "Jenkins", "Oracle"], desc: "Maintained data pipelines integrating with on-premises Oracle databases. Configured AWS Elastic Beanstalk multi-container Docker environments and managed microservices via ECS Fargate and Minikube. Implemented CI/CD using Jenkins and CircleCI." },
    { title: "NorthBay Labs", date: "Jul 2019 - Sep 2019", tech: ["ELK Stack", "Grafana", "AWS SAM", "Linux Shell Scripting"], desc: "Developed a collection of CloudFormation Custom Resources. Engineered the ELK Stack architecture for log visualization via Kibana. Installed Grafana via Terraform and instituted Linux shell scripting for automated log management." },
