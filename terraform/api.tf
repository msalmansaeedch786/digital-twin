...
resource "aws_lambda_function" "api" {
  ...
  environment {
    variables = {
      ...
      ALLOWED_ORIGINS   = "https://feature-aws-enterprise-migration.${aws_amplify_app.frontend.default_domain},http://localhost:3000"
    }
  }
...
resource "aws_apigatewayv2_api" "main" {
  ...
  cors_configuration {
    allow_origins     = ["https://feature-aws-enterprise-migration.${aws_amplify_app.frontend.default_domain}", "http://localhost:3000"]
